                    ...
                    <table width="93%"  border="1" align="center" cellpadding="1" cellspacing="1" class="GreyBg2">
                      <tr class="GreyBg0"> 
                        <td class="px16B"><table width="94%"  border="0" cellpadding="0" cellspacing="1">
                            <tr> 
                              <td width="55">标题</td>
                              <td width="324"><input name="title" type="text" id="title" size="46" value="<? echo $obj->GetField("title");?>" > 
                                <font color="#FF0000"> * </font></td>
                              <td width="260"><input name="sort_id" type="text" id="sort_id" size="20" value="<? echo $obj->GetField("sort_id");?>" readonly="true">
                                <font color="#FF0000">* </font><a href="sort.php" target="_blank">信息分类 </a></td> 
                                <td> URL <input name="url" type="text" id="url" size="20" value="<?=$obj->GetField("url")?>"></td>   
                            </tr>
                          </table></td>
                      </tr>
					   ...
					   <tr class="GreyBg0"> 
                        <td class="px16B">
						  ...
						  <tr>
						    <td colspan="5" align="center"><input type="submit" name="Button" value="确定">
&nbsp;
