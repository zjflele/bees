...
<?
	...
	{
?>
	<tr bgcolor="#F8F9FC"><td><?=$rec[id]?></td><td><a href="/show_article.php?id=<?=$rec[id]?>" target=_blank><?=$rec[title]?></a></td>
	<td align="center"><a href="shu_news_edit.php?id=<?=$rec['id']?>">编辑</a>&nbsp;&nbsp;&nbsp;<a href="shu_news_manage.php?action=del&id=<?=$rec['id']?>">删除</a></td>
