...
if ($_FILES['upfile_left']['type']=="image/pjpeg" or $_FILES['upfile_left']['type']=="image/jpeg" or $_FILES['upfile_left']['type']=="image/gif" or $_FILES['upfile_left']['type']=="application/x-shockwave-flash"){
		...
		if ($_FILES['upfile_left']['type']=="image/pjpeg" or $_FILES['upfile_left']['type']=="image/jpeg")
			{
				$l_name=".jpg";
				$temparr['index_down_ads_left_type'] = 'img';
			}
		...
		if ($_FILES['upfile_left']['type']=="application/x-shockwave-flash")
			{
				$l_name=".swf";
				$temparr['index_down_ads_left_type'] = 'flash';
			}
		$new_name='index_down_ads_left'.$l_name;
		// 构造文件名		
		...
		{		
			...
			$temparr['index_down_ads_left_filename'] = $new_name;			
		}
}

$temparr['index_down_ads_left_show'] = $_POST['ads_left_show'];
$temparr['index_down_a_href_left'] = $_POST['a_href_left'];
//print_r($temparr);exit;
        ...
        <TR>
		  ...
		  <table width="80%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#9999FF">
                    <form enctype="multipart/form-data" name="form" method="post" action="?action=action">
					  <tr bgcolor="#FFFFFF">
                        <td colspan="2"><?php 
						if (FileIO::isFileExists("../../upload/index_ads/".$temparr['index_down_ads_left_filename'])){
							echo "[ <a href=\"../../upload/index_ads/".$temparr['index_down_ads_left_filename']."\" target=_blank>预览</a> ]" ;
						}?></td>
                      </tr>
					  <tr bgcolor="#FFFFFF">
                        <td width="14%">是否显示：</td>
                        <td width="86%"><input name="ads_left_show" type="checkbox" id="ads_left_show" size="50" value="1" <?php if ($temparr['index_down_ads_left_show']==1) echo 'checked';?>></td>
                      </tr>
					  <tr bgcolor="#FFFFFF">
                        <td width="14%">链接地址：</td>
                        <td width="86%"><input name="a_href_left" type="text" id="a_href_left" size="50" value="<?php echo ($temparr['index_down_a_href_left']=='')?'http://':$temparr['index_down_a_href_left'];?>">
                        <font color="#FF0000">(对FLASH无效)</font></td>
                      </tr>
                      <tr bgcolor="#FFFFFF">
                        <td>相关附件：</td>
                        <td><input type=file name=upfile_left size=35 value="">
                          <font color="#FF0000">*(只可以上传.gif/.jpg图片和FLASH文件,空为不修改,推荐大小：700*91)</font>                          </td>
                      </tr>					 
					   <tr bgcolor="#FFFFFF">
                        <td colspan="2" align="left"><font color="#FF0000">*(文件存放在/upload/index_down_ads目录下)</font></td>
                      </tr>
                      <tr bgcolor="#FFFFFF">
