        ...
        <TR>
		  ...
		  <table width="80%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#9999FF">
                    <form enctype="multipart/form-data" name="form" method="post" action="?action=action">
					  <tr bgcolor="#FFFFFF">
                        <td colspan="2"><strong>左侧</strong>：<?php 
						if (FileIO::isFileExists("../../upload/index_ads/".$temparr['index_top_ads_left_filename'])){
							echo "[ <a href=\"../../upload/index_ads/".$temparr['index_top_ads_left_filename']."\" target=_blank>预览</a> ]" ;
						}?></td>
                      </tr>
					  <tr bgcolor="#FFFFFF">
                        <td width="14%">是否显示：</td>
                      ...
                      <tr bgcolor="#FFFFFF">
                        ...
                        <td><input type=file name=upfile_left size=35 value="">
                          <font color="#FF0000">*(只可以上传.gif/.jpg图片和FLASH文件,空为不修改,推荐大小：250*90px)</font>                          </td>
                      </tr>
					  <tr bgcolor="#FFFFFF">
                        <td colspan="2"><strong>右侧</strong>：<?php 
						if (FileIO::isFileExists("../../upload/index_ads/".$temparr['index_top_ads_right_filename'])){
							echo "[ <a href=\"../../upload/index_ads/".$temparr['index_top_ads_right_filename']."\" target=_blank>预览</a> ]" ;
						}?>                 </td>
                      </tr>
					  <tr bgcolor="#FFFFFF">
                        <td width="14%">是否显示：</td>
                      ...
                      <tr bgcolor="#FFFFFF">
                        ...
                        <td><input type=file name=upfile_right size=35 value="">
                          <font color="#FF0000">*(只可以上传.gif/.jpg图片和FLASH文件,空为不修改,推荐大小：740*90px)</font>                          </td>
                      </tr>					 
					   <tr bgcolor="#FFFFFF">
                        <td colspan="2" align="left"><font color="#FF0000">*(文件存放在/upload/index_top_ads目录下)</font></td>
                      </tr>
                      <tr bgcolor="#FFFFFF">
