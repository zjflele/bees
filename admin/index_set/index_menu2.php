<?
	...
	if (submitcheck('editmenu'))
	{
		...
		alertmessage("修改成功!",1,'index_menu2.php?mid='.$mid);
	}
	if ($ac=='edit' && $id){
		$minfo = getrow("select * from ".TABLEPRE."index_menu where id=$id and siteid=".$_SESSION['bees_SiteId']);
	}
	
	if ($ac=='del' && $id){
		$db->query("delete from ".TABLEPRE."index_menu where id=$id");
		alertmessage("删除成功!",1,'index_menu2.php?mid='.$mid);	
	}
	$arrParent = getrow("select * from ".TABLEPRE."index_menu where sid=".$mid." and siteid=".intval($_SESSION['bees_SiteId']));
	$arrMenu = getlist("select * from ".TABLEPRE."index_menu where sheight=2 and parentid=$mid and siteid=".$_SESSION['bees_SiteId']."  order by display asc,id asc");
	//二级分类列表
	$userinfo = getrow("select * from ".TABLEPRE."users where userid = ".$_SESSION['bees_UserId']);
	$arrSort1 = getlist("SELECT id, name FROM `".TABLEPRE."sort` WHERE parentid=$mid  AND id in (".$userinfo['my_sort'].")");
        ...
        <TR>
          <TD height="543" bgColor=#f8f9fc valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
								  ...
								  <tr> 
                                        <td bgcolor="#FFFFFF">
										[<a href="index_menu1.php">一级分类</a>]-><?=$arrParent['name']?>
										</td></tr>
                                      <tr> 
                                        <td bgcolor="#FFFFFF">
										 <table width="100%" cellpadding="3" cellspacing="0" border="0">
											...
											if ($arrMenu){
											  ...
											  <td align="left">	                     
												<a href="index_menu2.php?ac=edit&mid=<?=$mid?>&id=<?=$v["id"]?>"><img src="../images/edit.png" alt="编辑" width="12" height="13" border="0" align="absmiddle"></a> 
                                                <a href="index_menu2.php?ac=del&mid=<?=$mid?>&id=<?=$v["id"]?>"><img src="../images/del.png" alt="删除" width="11" height="13" border="0" align="absmiddle"></a>
												</td>
												</tr>
										   <?
											 $i+=1;  					
                                ...
                                <tr> 
								  ...
								  <table width="100%" border="1" cellspacing="1" cellpadding="0" bgcolor="#3399CC" bordercolor="#FFFFFF">
                                      ...
                                      <tr> 
                                        <form name="form1" method="post" action="index_menu2.php?mid=<?=$mid?>">
                                          <td bgcolor="#FFFFFF"> <div align="center"> <br>
                                          <table width="61%" border="1" cellspacing="1" cellpadding="0" bgcolor="#3399CC" bordercolor="#FFFFFF">
                                            <tr  bgcolor="#FFFFFF">
                                            ...
                                            <tr bgcolor="#FFFFFF">
                                              <td width="23%" rowspan="3" align=right valign="top">导航类型：</td>
                                          ...
                                          <table width="61%" border="1" cellspacing="1" cellpadding="0" bgcolor="#3399CC" bordercolor="#FFFFFF">
                                            <tr  bgcolor="#FFFFFF">
                                              <td width="24%" align=right>
                                                导航名称：</td>
                                                    <td width="76%" align=left><input type="text" name="name" size="20" onMouseOver=this.focus() onFocus=this.select()></td>
                                            </tr>
                                            <tr bgcolor="#FFFFFF">
                                              <td width="24%" rowspan="2" align=right valign="top">导航类型：</td>
											...
											<tr  bgcolor="#FFFFFF">
                                              <td width="24%" align=right>
                                                显示顺序：</td>
                                                    <td width="76%" align=left><input type="text" name="display" size="20"  value="1"></td>
                                            </tr>
                                            <tr bgcolor="#FFFFFF">
                                              <td colspan="2" align=center>
