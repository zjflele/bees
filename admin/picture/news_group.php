<?
	...
	if ($nid){
		...
		if ($hb){
			...
			$db->query("delete from wts_picture_category where id in (".$str_sorts.")");//删除补合并分类
		}
				...
				?>
				  ...
				  ?>
											  ...
											  <input type="text"  style="width:150px;" name="name[<?=$rec['id']?>]" value="<?=$rec['name']?>">						  
                                                ...
                                                <td align="left">		 
                                                <a href="news_group.php?pid=<?=$rec["id"]?>">编辑子栏目</a> 
...
分类：</td>
                                                  <td  align=left><input type="text" name="dirname" size="20" onMouseOver=this.focus() onFocus=this.select()>
                                                    ...
                                                    <input type="submit" name="addsort" value="添加分类"></td>
                                                </tr>
