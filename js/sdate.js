...
function calcDuration(f) {
	...
	var int_st_date = new String(f.start_date.value + f.start_hour.value + f.start_minute.value);
	var int_en_date = new String(f.end_date.value + f.end_hour.value + f.end_minute.value);

	int_st_date = int_st_date.replace('-','');
	int_st_date = int_st_date.replace('-','');

	int_en_date = int_en_date.replace('-','');
	int_en_date = int_en_date.replace('-','');
...
function calcFinish(f) {
	...
	var int_st_date_time = new String(f.start_date.value + f.start_hour.value + f.start_minute.value);	
	int_st_date_time = int_st_date_time.replace('-','');
	int_st_date_time = int_st_date_time.replace('-','');
	...
	f.end_date.value = e.getUTCFullYear()+"-"+tz2+(e.getMonth()+1)+"-"+tz1+e.getDate(); // MM/DD/YY
